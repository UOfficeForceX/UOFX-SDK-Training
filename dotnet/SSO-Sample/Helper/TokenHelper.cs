...
namespace SSO_Sample.Helper
{
    public static class TokenHelper
    {
        private static readonly string _ValidIssuer = "Ede.Uofx.SSO.Sample";
        private static readonly string _ValidAudience = "Uofx SSO.Sample";
